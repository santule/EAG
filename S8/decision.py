...
3. When the final mcqs are generated, respond using:
   MCQS: [your final result]
...
- Write to application: {perception.write_to_application or 'None'}
...
- Task: Create 2 multiple-choice questions (MCQs) based on the content available to you in the knowledge base with difficulty level easy and provide explaination and write all mcqs to the application stated by the user.
